...
<dialog
	...
	class="glass relative m-auto transform overflow-hidden rounded-xl !bg-black/90 p-6 text-left text-white shadow-xl transition-all sm:w-full sm:max-w-lg border border-gray-700"
	bind:this={dialog}
